...
/*#__PURE__*/
function () {
  function Navigation(trigger, nav) {
...
window.addEventListener('load', function () {
  var navigationTrigger = document.querySelector('.burger');
  var navigationList = document.querySelector('.main-navigation__list');
  var navigation = new _components_Navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"](navigationTrigger, navigationList);
});
